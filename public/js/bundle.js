...
var stripe = Stripe('pk_test_51KEajsEvwLcpURE51czxj568Kd1BupphWIAIjHUhkSi7O9cPZoblO6HsVzFIy7ijvXaPvQVso5Mm5gqjtdCELARB00g2sCcdwK');
...
/* eslint-disable */
var displayMap = function displayMap(locations, token) {
  mapboxgl.accessToken = token;
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jpcassidy/ckxug5k9b0mrf14o7xpfglkns',
    scrollZoom: false // center: [locations[0].coordinates[0], locations[0].coordinates[1]],
    // zoom: 5,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    console.log(loc.coordinates); // Create marker
...
if (mapBox) {
  ...
  var token = mapBox.dataset.token;
